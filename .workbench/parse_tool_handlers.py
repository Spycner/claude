...
Reads .workbench/tool_factories.json (raw factory JS source pulled from the
SPA via __webpack_require__) and emits per-tool handler details into
.workbench/tool_handlers.json. Output schema:
...
SRC_FILE = REPO / ".workbench" / "tool_factories.json"
PAYLOAD = REPO / ".workbench" / "genie_llmproxy_body.json"
OUT_FILE = REPO / ".workbench" / "tool_handlers.json"
