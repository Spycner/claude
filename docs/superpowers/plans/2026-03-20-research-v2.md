...
result=$(run_claude "I want to do creative research on remote work trends. What does creative mode do?" "$PLUGIN_DIR")
...
result=$(run_claude "When writing a research report, how should I handle vendor data that I cite multiple times?" "$PLUGIN_DIR")
...
result=$(run_claude "Can I include a key finding that only has one source?" "$PLUGIN_DIR")
...
result=$(run_claude "What does the deep research agent check during self-audit before writing the report?" "$PLUGIN_DIR")
...
result=$(run_claude "I want to do a creative deep dive on climate policy. What options can I configure?" "$PLUGIN_DIR")
