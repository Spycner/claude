...
_(body truncated at 2,200 chars; full 10696-byte source is in `.workbench/tool_handlers.json` under `createAsset.body` and the captured factory in `.workbench/tool_factories.json`.)_
