...
_(body truncated at 2,200 chars; full 3228-byte source is in `.workbench/tool_handlers.json` under `querySearch.body` and the captured factory in `.workbench/tool_factories.json`.)_
