...
Reads extraction/data/skill-dump.json (extracted from the SPA webpack chunks)
...
EXTRACTION = REPO_ROOT / "plugins" / "databricks" / "skills" / "genie-code" / "references" / "extraction"
DUMP = EXTRACTION / "data" / "skill-dump.json"
