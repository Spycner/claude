...
Edit this file freely; it lives in your project at `.workbench/deck-standards.md` and your edits override the bundled default.
...
- **S5 Headlines carry the takeaway.** A slide title states what the audience should conclude, not the topic ("Migration cut costs 40%", not "Cost analysis").
...
- **S14 Speaker notes exist and match.** Every content slide has notes; notes describe the slide they are attached to.
