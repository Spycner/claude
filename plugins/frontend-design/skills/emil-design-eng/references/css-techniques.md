...
Transform mastery (percentages, scale-children behavior, 3D, transform-origin) and `clip-path` patterns (inset reveals, hold-to-delete, image reveals, comparison sliders). Read when reaching for transforms or clipping.
