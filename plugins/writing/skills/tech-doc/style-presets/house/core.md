...
- Sentence case for all titles, headings, and subheadings.
- Skip end punctuation on headings of three or fewer words.
- Front-load keywords.
...
- Avoid idioms, regional expressions, sports metaphors, and cultural assumptions.
- Short sentences. Simple constructions.
- Use unambiguous date formatting: ISO format (YYYY-MM-DD) or spelled-out month (January 5, 2026).
