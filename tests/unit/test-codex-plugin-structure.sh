...
[ "$plugin_count" -eq 12 ] || fail "Expected 12 Codex marketplace plugins, got $plugin_count"

for plugin in atlassian google-workspace research writing runtime-bridge agent-system-management workbench terminal frontend-design playground databricks learning; do
